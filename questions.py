...
QUESTIONS = [
    # {"question": "...", "expects": "..."},
    {"question": "How much printing does each student get per semester?", "expects": "$30"},
    {"question": "At what time the health center open for walk-ins?", "expects": "8am"},
    {"question": "How's winter actually feels like in the campus?", "expects": "mid-November to early March"},
    {"question": "Which study rooms have white boards?", "expects": "210 and 211"},
    {"question": "How much does a wash cost in the Morrow House laundry room?", "expects": "$1.50"}
]
